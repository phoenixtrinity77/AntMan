...
public class DownloadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AdView adView1 = (AdView)findViewById(R.id.antman9);
        AdView adView2 = (AdView)findViewById(R.id.antman10);
        AdView adView3 = (AdView)findViewById(R.id.antman11);
        AdView adView4 = (AdView)findViewById(R.id.antman12);
        AdView adView5 = (AdView)findViewById(R.id.antman13);
        AdView adView6 = (AdView)findViewById(R.id.antman14);
        AdView adView7 = (AdView)findViewById(R.id.antman15);
        AdView adView8 = (AdView)findViewById(R.id.antman16);
        AdView adView18 = (AdView)findViewById(R.id.antman18);
    ...
    private Uri SaveImage(Bitmap finalBitmap) {
        ...
        File myDir = new File(root + "/ANTMAN");
        myDir.mkdirs();
